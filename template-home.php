...
<!-- HOT DEALS -->
	...
	<div id="horizontalTab">
        ...
        <div id="tab-1">
            <div class="hot-d">
				...
				<div class="hd-right">
					<div class="hd-block">
						<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/irland1.jpg" alt="" /></a>
						<div class="hd-block-text">
							...
							<div class="block-text-bottom">
								<span class="price">$150</span>
								<span><img src="<?php echo get_template_directory_uri(); ?>/img/ship.png" alt="" /></span>
								<span class="date">5 days</span>
							</div>
						</div>
					</div>
					<div class="hd-block">
						<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/finland.jpg" alt="" /></a>
						<div class="hd-block-text">
							<a href="#"><h3>Finland</h3></a>
							<p>The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to</p>
							<div class="block-text-bottom">
								<span class="price">$500</span>
								<span><img src="<?php echo get_template_directory_uri(); ?>/img/bus.png" alt="" /></span>
								<span class="date">5 days</span>
							</div>
						</div>
					</div>
				...
				<div class="hd-b">
					<div class="hd-block">
						<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/spain.jpg" alt="" /></a>
						<div class="hd-block-text">
					...
					<div class="hd-block">
						<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/bolgaria.jpg" alt="" /></a>
						<div class="hd-block-text">
					...
					<div class="hd-block">
						<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/czech.jpg" alt="" /></a>
						<div class="hd-block-text">
					...
					<div class="hd-block last">
						<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/irland.jpg" alt="" /></a>
						<div class="hd-block-text">
 ...
 <section class="gallery">
	...
	<div class="flexgallery carousel">
		<ul class="slides">
			<li>
			  <div class="img-wrap"><img src="<?php echo get_template_directory_uri(); ?>/img/cherly-2.png" alt="" />
				<a href="<?php echo get_template_directory_uri(); ?>/img/tour1-img.jpg" class="prettyphoto" ><div class="cover"><i class="fa fa-plus"></i> </div></a>
			  </div>
			...
			<li>
			  <div class="img-wrap"><img src="<?php echo get_template_directory_uri(); ?>/img/cherly.png" alt="" />
			  <a href="<?php echo get_template_directory_uri(); ?>/img/tour1-img.jpg" class="prettyphoto" ><div class="cover"><i class="fa fa-plus"></i> </div></a>
			  </div>
			  <div class="carousel-caption">
				<p>Cherly Bailey</p>
			...
			<li>
			  <div class="img-wrap"><img src="<?php echo get_template_directory_uri(); ?>/img/cherly-4.png" alt="" />
			  <a href="<?php echo get_template_directory_uri(); ?>/img/tour1-img.jpg" class="prettyphoto" ><div class="cover"><i class="fa fa-plus"></i> </div></a>
			  </div>
			  <div class="carousel-caption">
				<p>Cherly Bailey</p>
			...
			<li>
			  <div class="img-wrap"><img src="<?php echo get_template_directory_uri(); ?>/img/cherly-3.png" alt="" />
			  <a href="<?php echo get_template_directory_uri(); ?>/img/tour1-img.jpg" class="prettyphoto" ><div class="cover"><i class="fa fa-plus"></i> </div></a>
			  </div>
			  <div class="carousel-caption">
				<p>Cherly Bailey</p>
			...
			<li>
			  <div class="img-wrap"><img src="<?php echo get_template_directory_uri(); ?>/img/cherly-5.png" alt="" />
			  <a href="<?php echo get_template_directory_uri(); ?>/img/tour1-img.jpg" class="prettyphoto" ><div class="cover"><i class="fa fa-plus"></i> </div></a>
			  </div>
			...
			<li>
			  <div class="img-wrap"><img src="<?php echo get_template_directory_uri(); ?>/img/cherly-6.png" alt="" />
			  <a href="<?php echo get_template_directory_uri(); ?>/img/tour1-img.jpg" class="prettyphoto" ><div class="cover"><i class="fa fa-plus"></i> </div></a>
			  </div>
			  <div class="carousel-caption">
				<p>Cherly Bailey</p>
			...
			<li>
			  <div class="img-wrap"><img src="<?php echo get_template_directory_uri(); ?>/img/cherly-7.png" alt="" />
			  <a href="<?php echo get_template_directory_uri(); ?>/img/tour1-img.jpg" class="prettyphoto" ><div class="cover"><i class="fa fa-plus"></i> </div></a>
			  </div>
			  <div class="carousel-caption">
				<p>Cherly Bailey</p>
		...
		<div class="flexreview">
		  <ul class="slides">
			<li>
				...
				<div class="rev-foto">
					<img src="<?php echo get_template_directory_uri(); ?>/img/ava.jpg" alt="" />
				</div>
				<div class="rev-block">
					<div class="rev-head">
